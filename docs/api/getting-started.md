...
This guide will help you get started with TrogonEventStore in your Rust application.
...
::: info Gossip support
Single-node deployments support gossip, so `esdb+discover://` can be used for any
topology, including single-node setups.
:::
